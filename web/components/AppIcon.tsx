    ...
    >
      <defs>
        ...
        >
          ...
          <stop offset="20%" stopColor="#6C5CE7" stopOpacity="0.8" />
          <stop offset="50%" stopColor="#A29BFE" stopOpacity="1" />
          <stop offset="80%" stopColor="#6C5CE7" stopOpacity="0.8" />
      ...
      <polyline
        ...
        filter="url(#iconGlow)"
      />
      <circle cx="40" cy="8" r="2.5" fill="#A29BFE" opacity="0.9" />
    </svg>
  );
}
